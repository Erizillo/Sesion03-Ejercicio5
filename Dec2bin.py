...
if __name__ == "__main__":
    # Pide al usuario el n�mero binario a convertir 
    # Como el n�mero binario es un string, no hace falta usar int()
    numero_binario = input("Escribe el n�mero en binario que quieres convertir: ")

    # se llama a la funci�n bin2dec() para hacer la conversi�n
